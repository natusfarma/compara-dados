...
public class CartoesController {
    ...
    private static final String NOME = "Cartões";
    ...
    public ModeloListas<ModeloCartoes> processar(@RequestParam("ini") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate ini){
        return cartoesService.processar(ini,ini);
    }
